...
/*void task_fann_init_malloc(void);
void task_fann_init_data(void);
void task_fann_init_data2(void);
void task_fann_init_calloc(void);

#pragma PERSISTENT(TASK_FANN_INIT_MALLOC)
NewTask(TASK_FANN_INIT_MALLOC, task_fann_init_malloc, 0) // with self-field

#pragma PERSISTENT(TASK_FANN_INIT_DATA)
NewTask(TASK_FANN_INIT_DATA, task_fann_init_data, 0) // with self-field

#pragma PERSISTENT(TASK_FANN_INIT_DATA2)
NewTask(TASK_FANN_INIT_DATA2, task_fann_init_data2, 0) // with self-field

#pragma PERSISTENT(TASK_FANN_INIT_CALLOC)
NewTask(TASK_FANN_INIT_CALLOC, task_fann_init_calloc, 0) // with self-field
